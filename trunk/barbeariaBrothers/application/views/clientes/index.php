		<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<div class="table-responsive" id="tabClie">
							<!-- Table data -->
                        </div>
                        <!-- /tabFunc -->
				...
				<div class="row">
                	<div class="text-center">
                		<a href="<?= base_url() ?>clientes/form"><button type="button" class="btn btn-lg btn-primary"><i class=" fa fa-plus"></i> Cadastrar</button></a>
                	</div>
                </div>
                <!-- /.row -->
